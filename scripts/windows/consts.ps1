...
$script:OtelCollectorUrlDownload = 'https://github.com/open-telemetry/opentelemetry-collector-releases/releases/download/v0.75.0/otelcol-contrib_0.75.0_windows_amd64.tar.gz'
...
$script:OtelCollectorExeName = 'otelcol-contrib.exe'
