...
# Resources Mac directory
LOGZIO_RESOURCES_MAC_DIR="$LOGZIO_TEMP_DIR/resources-mac"

## Resources Mac Directories
# Resources Mac OTEL directory
OTEL_RESOURCES_MAC_DIR="$LOGZIO_RESOURCES_MAC_DIR/otel"
# Resources Mac Kubernetes directory
KUBERNETES_RESOURCES_MAC_DIR="$LOGZIO_RESOURCES_MAC_DIR/k8s"
# Resources Mac all directory
ALL_RESOURCES_MAC_DIR="$LOGZIO_RESOURCES_MAC_DIR/all"
...
OTEL_COLLECTOR_URL_DOWNLOAD='https://github.com/logzio/otel-collector-distro/releases/download/v0.75.0/otelcol-logzio-darwin_amd64.tar.gz'
...
LOGZIO_OTEL_COLLECTOR_SERVICE_NAME='com.logzio.OTELCollector'

## Service plist file
# Logz.io plist file name
LOGZIO_OTEL_COLLECTOR_SERVICE_PLIST_NAME="$LOGZIO_OTEL_COLLECTOR_SERVICE_NAME.plist"
# Logz.io plist file path
LOGZIO_OTEL_COLLECTOR_SERVICE_PLIST_FILE="/Library/LaunchDaemons/$LOGZIO_OTEL_COLLECTOR_SERVICE_PLIST_NAME"

## Service log file
# Logz.io OTEL collector service log file
LOGZIO_OTEL_COLLECTOR_SERVICE_LOG_FILE="$LOGZIO_OTEL_COLLECTOR_DIR/logzio_otel_collector.log"
